class EmpleadosController < BaseController
  ...
  private
    ...
    def empleado_params
      params.require(:empleado).permit(:identificacion, :idtipoidentificacion, :nombres, :apellidos, :telefonos, :correo, :direccion, :idgenero, :idcargo, :idarea, :idestadoemp, :eliminado)
    end
end
